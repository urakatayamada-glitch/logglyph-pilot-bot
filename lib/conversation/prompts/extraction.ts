...
# 【重要】一般的な認識と、その人固有の記憶を区別する

one_line_memory と memory_found の判定で、ここを間違えないでください。
...
**その人固有の記憶（これが欲しい）**
　「20代の頃は友達と朝5時まで飲み、そのまま仕事へ行くこともあった。」
　「高校時代、授業が終わると一人で海へ行って、暗くなるまで堤防に座っていた。」
　「入社3年目に大きい案件で失敗し、上司に呼ばれた日の夜に本気で辞めようと思った。」

違いは、**いつ・どこ・誰と・何を・何が起きたか**が入っているかどうかです。

会話の中に具体的な場面が語られているなら、**必ずそちらを one_line_memory にしてください。**
一般化してまとめ直さないこと。

会話が一般的な認識で止まっていて、具体的な場面がどこにも出ていない場合は、
**memory_found を false にしてください。**
「本人が何か答えた」ことは、記憶が語られたことと同じではありません。

# 各項目の意味

- one_line_memory: 本人に見せる一行のログ。本人の言葉に近い形で。具体的な場面が語られているなら、その場面を書く。話すことがなかった会話なら、その事実をそのまま書く。
...
- hidden_candidate: 本人がまだはっきり言葉にしていなかったが、発言に明確な根拠がある「意味の断片」を一文で。根拠が薄い場合は必ず null。断定せず、本人の発言の範囲を超えないこと。
  ...
  **重要：本人が既に口にしたことの言い換え・要約は hidden_candidate ではありません。**
  本人が「前回も同様だったのでいまだに不安」と言っているとき、
  「前回も同様の進行状況で不安が続いている」と書くのは単なる言い換えであり、誤りです。
  この場合は null にしてください。

  hidden_candidate が成立するのは、本人の複数の発言を並べて初めて見えてくる、
  本人自身は口にしていない意味がある場合だけです。
  ほとんどの会話では null になります。それが正常です。
  無理に埋めないでください。
- memory_trigger_category: 会話の中心にあった話題のカテゴリ。
- confidence: この抽出全体の確からしさ。0.0〜1.0。会話が薄い場合は低くする。
- memory_found: 本人が**具体的な過去の出来事・場面**を語ったなら true。
  一般的な認識や現在の状態を述べただけ、あるいは何も語らなかったなら false。
  「答えはしたが、場面は出ていない」は false です。`;
