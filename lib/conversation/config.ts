 ...
 *
 * ⚠ v1.6.0（2026-09-16）は最終テストの**途中**で入れた変更である。
 *   これより前に話した人と後に話した人は、会話そのものが違う。
 *   sessions.prompt_version にこの値が入るので、
 *   **集計するときは v1.5.1 と v1.6.0 を分けて読むこと。**
 *   混ぜると、Next-Day Return の差が体験の差なのか会話の差なのか分からなくなる。
 *
 *   変更内容：おうむ返しの2連続を禁止し、共感・一般論を解禁した
 *   （実ユーザーの「おうむ返しが2回続いて萎えた」という指摘への対応）
 */
